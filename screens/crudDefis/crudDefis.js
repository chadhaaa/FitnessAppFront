...
const CrudDefis = () => {
  ...
  const getDefis = async () => {
    ...
    const response = await axios
      .get("http://192.168.108.64:8000/api/challenges", { headers })
      .then((res) => {
        console.log(res);
        setDefi(res.data);
  ...
  const handleDelete = (item) => {
    ...
    const response = axios
      .delete("http://192.168.108.64:8000/api/challenge/" + item._id, {
        headers,
      })
      .then((res) => {
        var respo = res.data;
  ...
  const handleSave = () => {
    if (hideId == null) {
      ...
      axios
        .post("http://192.168.108.64:8000/api/challenge", formdata)
        .then((res) => {
      ...
      axios
        .put("http://192.168.108.64:8000/api/challenge/" + hideId, formdata)
        .then((res) => {
          const response = res.data;
          getDefis();
          setGoal("");
